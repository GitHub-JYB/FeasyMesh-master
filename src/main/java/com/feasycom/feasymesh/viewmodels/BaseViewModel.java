...
import com.feasycom.feasymesh.library.models.GenericLevelServerModel;
import com.feasycom.feasymesh.library.models.GenericOnOffServerModel;
...
abstract class BaseViewModel extends ViewModel {
    ...
    public ProvisionedMeshNode getPhoneNodes(){
        return mNrfMeshRepository.getPhoneNodes().getValue();
    }

    public void setNodes(ProvisionedMeshNode nodes){
        mNrfMeshRepository.setNodes(nodes);
    }
