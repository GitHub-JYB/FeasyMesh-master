...
public class VendorModelActivity extends BaseModelConfigurationActivity {
    ...
    private static final String TAG = "VendorModelActivity";
        ...
        if (model instanceof VendorModel) {
            ...
            actionSend.setOnClickListener(v -> {
                ...
                if (model.getBoundAppKeyIndexes().isEmpty()) {
                    /*model.setBoundAppKeyIndex(mViewModel.getNetworkLiveData().getSelectedAppKey().getKeyIndex());*/
    ...
    public void sendVendorModelMessage(final int opcode, final byte[] parameters, final boolean acknowledged) {
        ...
        if (element != null) {
            ...
            if (model != null) {
                final int appKeyIndex = mViewModel.getMeshManagerApi().getMeshNetwork().getAppKey(0).getKeyIndex();
